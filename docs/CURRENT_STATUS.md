...
## 1. 현재 학습 진행 단계
* **진행 단계**: **3단계 (문서 목록 조회 API 진행 중)**
* **목표 진도**: [DEVELOPMENT_PLAN.md](file:///c:/Users/Dalyume/Documents/DAL/Coding/notion-clone/docs/DEVELOPMENT_PLAN.md) 기준 3단계 완료
...
| **3단계** | 목록 조회 API | **진행 중 (In Progress)** | `useEffect` 최초 데이터 fetch 적용 |
...
## 3. 진행 중인 기능
* **현재 태스크**: 3단계 문서 목록 조회 API
  * 기능 명세 작성 완료
  * 다음 작업: Axios와 JSON Server 설치
...
* **대상**: 3단계 - 문서 목록 조회 API
  ...
  * `useEffect`로 최초 목록 요청 및 로딩·오류 처리
